...
def build_block_config_from_model(cfg: ModelConfig, **overrides) -> BlockConfig:
    ...
    bc = BlockConfig(
        ...
        resid_dropout=float(overrides.pop("resid_dropout", getattr(cfg, "resid_dropout", 0.0))),
        attn_dropout=float(overrides.pop("attn_dropout", getattr(cfg, "attn_dropout", 0.0))),
        mlp_dropout=float(overrides.pop("mlp_dropout", getattr(cfg, "mlp_dropout", 0.0))),
