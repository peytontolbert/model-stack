...
common_env=(
  ...
  MODEL_STACK_TRAINABLE_BITNET_TRAINING_FORWARD="${MODEL_STACK_TRAINABLE_BITNET_TRAINING_FORWARD:-dense_ste}"
  ...
  MODEL_STACK_TRAINABLE_BITNET_BACKWARD_GRAD_INPUT="${MODEL_STACK_TRAINABLE_BITNET_BACKWARD_GRAD_INPUT:-dense}"
  MODEL_STACK_TRAINABLE_BITNET_BACKWARD_GRAD_WEIGHT="${MODEL_STACK_TRAINABLE_BITNET_BACKWARD_GRAD_WEIGHT:-dense}"
