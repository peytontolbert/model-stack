...
python /data/transformer_10/scripts/train_f5tts_2step_from_teacher_cache.py \
  --cache-dir /data/transformer_10/cache/f5tts_voiceclone_libritts_full_hardphrase_teacher24_speechtext_v0 \
  ...
  --output-dir /data/transformer_10/checkpoints/f5tts_q4_6step_teacher24_text_contrast_v33 \
  --teacher-steps 24 \
  --student-steps 6 \
